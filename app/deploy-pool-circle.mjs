...
//
// Requires: CIRCLE_API_KEY, CIRCLE_ENTITY_SECRET, a deployer wallet id
//   (CIRCLE_DEPLOYER_WALLET_ID, else CIRCLE_PROVIDER_WALLET_ID),
...
const required = {
  ...
  CIRCLE_DEPLOYER_WALLET_ID:
    env.CIRCLE_DEPLOYER_WALLET_ID ?? env.CIRCLE_PROVIDER_WALLET_ID,
  USDC: env.USDC,
